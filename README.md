...
## Data Structure
    HashMap
## Project Summary 
**This is Sprinboot project of Url Hit Count Project the each user has username and hitcount.we can perform following operations using this project**
* we can get urlhitcount by username .
* we can get all hit count.
